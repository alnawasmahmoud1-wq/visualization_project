...
def build_iocs(report_path: str, pcap_path: str = None, manual_path: str = None) -> tuple:
    ...
    # Also pull in IPs/domains the sample TRIED to reach via Windows API
    # calls (InternetConnect*, ConnectEx, GetAddrInfoEx...) - this is what
    # actually has data in a Host-Only sandbox, since report['network']
    # stays empty even when the malware attempted a real connection.
